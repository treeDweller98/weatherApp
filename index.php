...
<body>
    <header>
        WeatherChecker
        <p>forecasts around the world</p>
    </header>

    <aside class="scrollspy-bar">
        <ul>
            <li> <a href="#weather-today" class="dot" data-scroll="AboutMe"><span> about me </span></a></li>
            <li> <a href="#forecast" class="dot" data-scroll="MyWork"><span> my work </span></a></li>
        </ul>
    ...
    <main>
        <?php
            ...
            // Get coordinates of user location and fetch weather data
            ...
            $iconURL = "https://openweathermap.org/img/wn/" . $weather->current->weather[0]->icon .".png";
            ...
            $windDegree = ($windDegree < 100) ? ("0" . strval(windDegree)) : $windDegree
        ?>

        <section id="weather-today">
            <form action="index.php" method="POST" class="needs-validation" novalidate>

                <div class="input-group input-group-sm rounded-pill bg-dark p-3">
                    <!-- Select Country -->
                    ...
                    <!-- Search city -->
                    <button type="submit" value="Submit" class="btn rounded-circle p-2">
            ...
            <div>
                ...
                <div>
                    ...
                    <h6>
                        ...
                        <span class="text-muted pe-3 ps-1">Wind: </span><?php echo $windSpeed."m/s bearing ".$windDegree ."°"; ?>
                    </h6>
                </div>
                ...
                <div class="row">
                    <?php
                        ...
                        foreach ( $weather->daily as $day ) {
                            ...
                            $dt->setTimezone(new DateTimeZone($weather->timezone));
                        ...
                        echo '<div class="card text-white bg-dark shadow p-3 mb-2">';
                    ...
                    <div class='col-lg-4 col-md-6 col-sm-12'>
                        <div class="card text-white bg-dark shadow p-3 mb-2">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">My First Bootstrap Site</h5>
